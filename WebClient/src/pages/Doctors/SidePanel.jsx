    ...
    return (
        <div className="shadow-panelShadow p-3 lg:p-5 rounded-md">
            <div className="flex items-center justify-between">
                <p className="text__para mt-0 font-semibold">Giá tiền: </p>
            ...
            <div className="mt-[30px]">
                <p className="text__para mt-0 font-semibold text-headingColor">Thời gian đặt lịch:</p>

                <ul className="mt-3">
                    <li className="flex items-center justify-between mb-2">
                        <p className="text-[15px] leading-6 text-textColor font-semibold">4:00 PM</p>
                        <p className="text-[15px] leading-6 text-textColor font-semibold">4:00 PM</p>
                    </li>
                    <li className="flex items-center justify-between mb-2">
