...
const DoctorCard = ({ doctor }) => {
    ...
    const { id, name, image, examination_Address, speciality } = doctor
    ...
    return (
        <div className="p-3 lg:p-5">
            ...
            <div className="mt-2 lg:mt-4 flex items-center justify-between">
                <span className='bg-[#CCF0F3] text-irisBlueColor py-1 px-2 lg:py-2 lg:px-6 text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded'>{speciality.name}</span>
            ...
            <div className='mt-[18px] lg:mt-5 flex items-center justify-between'>
                ...
                <div>
                    <h3 className='text-[16px] leading-7 lg:text-[18px] lg:leading-[30px] font-semibold text-headingColor'>+{244} patients</h3>
                    <p className='text-[14px] leading-6 font-[400] text-textColor'>At {examination_Address}</p>
                </div>
